...
class PromptManager:
    ...
    def render_turbo_deliverables(
        ...
        system = (
            ...
            "5. 'action_items': Extract ONLY genuine, actionable post-meeting work deliverables and tasks assigned to people (e.g. 'Deploy Redis cluster', 'Run proposed stage name by David for feedback', 'Update meeting template with anniversary section').\n"
            ...
            "6. 'decisions': Ratified agreements, architecture choices, policy changes, or formal approvals with approvers.\n"
