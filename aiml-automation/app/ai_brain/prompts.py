...
class PromptManager:
    ...
    def render_turbo_deliverables(
        ...
        system = (
            ...
            "6. 'decisions': Extract ALL ratified agreements, milestone plans, sprint scope resolutions, architectural choices, consensus conclusions, survey/release strategies, policy approvals, or resolved approaches established during the meeting.\n"
            "   ⚠️ MANDATORY: Every technical sync, milestone review, or team meeting ALWAYS establishes agreed directions, prioritized milestones, or ratified plans (e.g. 'Target 12.4 milestone release deliverables and prioritize survey strategy' or 'Adopt proposed stage name Enrichment across security and compliance workflows'). Extract at least 1-3 concrete agreed decisions or governance resolutions established by the team.\n"
            "   For each decision provide:\n"
            "   - 'description': Clear, definitive statement of the agreed resolution, milestone plan, or policy.\n"
            "   - 'rationale': Why this direction or approach was chosen.\n"
            "   - 'approved_by': List of key stakeholders or leaders who approved/ratified it (e.g. ['Wayne (Meeting Chair)', 'David DeSanto'] or ['Team Consensus']).\n"
            ...
            "7. 'risks': Extract ALL operational, technical, timeline, security, dependency, or workflow risks/blockers discussed.\n"
            "   For each risk provide:\n"
            "   - 'description': Concrete statement of the risk, bottleneck, or vulnerability (e.g. 'Approval rules potentially slowing down developer workflows' or 'Payment gateway webhook timeouts during peak traffic').\n"
            "   - 'severity': 'Critical', 'High', 'Medium', or 'Low'.\n"
            "   - 'probability': 'High', 'Medium', or 'Low'.\n"
            "   - 'impact': Expected downside impact if unmitigated.\n"
            "   - 'mitigation': Actionable mitigation step agreed upon or proposed to mitigate the risk.\n"
            "   - 'owner': Who is accountable for monitoring or resolving this risk.\n"
            "   - 'evidence_quote': Verbatim quote from the transcript citing the risk.\n\n"
